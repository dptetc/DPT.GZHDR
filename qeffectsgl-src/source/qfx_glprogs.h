...
"if ( depth > Local0.z ) depth = Local0.z;\n"
"gl_FragColor.rgb = depth;\n"
"gl_FragColor.a	= 1.0;\n"
"}\n";
...
"if ( depth > Local0.w ) depth = Local0.w;\n"
...
"float ao = Local1.z * 256.0f * depthDiff * (2.0 - depthDiff) * rangeDiff;\n"
"return ao;\n"
"}\n"
"void main(void)\n"
"{\n"
...
"float w = distScale + (noise.x*(1.0-noise.x)) * Local0.z; w *= Local1.w;\n"
"float h = distScale + (noise.y*(1.0-noise.y)) * Local0.w; h *= Local1.w;\n"
"vec2 ofs;\n"
"float d;\n"
"int samples = 3;\n"
"int rings = 3;\n"
